...
<template>
    <div class="d-flex justify-content-between">
        <div class="flex-column" style="width: 45%">
            ...
            <select class="form-control" :id="name + number + 'LinkTarget'" v-model="link.target" @change="chooseTarget($event)">
        ...
        <div class="flex-column" style="width: 45%">
            ...
            <input :id="name + number + 'LinkText'" type="text" class="form-control" v-model="link.text"/>
        </div>
    </div>
</template>
<script>
export default {
    props: ["val", "available_sections", "name", "number"],
