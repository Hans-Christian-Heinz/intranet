...
<div class="form-group row">
    ...
    <input type="text" form="{{ $form }}" name="shortTitle" placeholder="kurzer Titel" id="shortTitle" maxlength="30"
...
<div class="form-group row">
    ...
    <input type="text" form="{{ $form }}" name="longTitle" placeholder="langer Titel" id="longTitle" maxlength="100"
