...
<div class="form-group row">
    ...
    <input type="text" form="{{ $form }}" name="shortTitle" id="shortTitle" @if($disable) disabled @else placeholder="kurzer Titel" @endif
...
<div class="form-group row">
    ...
    <input type="text" form="{{ $form }}" name="longTitle" id="longTitle" @if($disable) disabled @else placeholder="langer Titel" @endif
