                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route("bewerbungen.companies.reviews.store", $company) }}" method="POST">
                                @csrf

                                <div class="form-group mb-4">
                                    <label for="comment">Bewertung</label>
                                    <textarea class="form-control" name="comment" id="comment" rows="3" placeholder="Begründen Sie Ihre Bewertung">{{ old("comment") }}</textarea>
                                    @error("comment")
